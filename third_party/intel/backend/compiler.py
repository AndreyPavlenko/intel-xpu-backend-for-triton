...
class XPUBackend(BaseBackend):
    ...
    def parse_target(self, tgt_prop) -> dict:
        ...
        # These functional features are hardcoded for XE4 for now because we have no
        # reliable source of target features yet.
        dev_prop['has_subgroup_matrix_multiply_accumulate'] = False
