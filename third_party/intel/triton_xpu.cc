...
#define ADD_PASS_WRAPPER_OPT_7(name, builder, ty0, ty1, ty2, ty3, ty4, ty5,    \
                               ty6)                                            \
...
void init_triton_intel_passes_ttgpuir(py::module &&m) {
  ...
  ADD_PASS_WRAPPER_OPT_7("add_triton_annotate_module",
                         gpu::intel::createTritonAnnotateModule, unsigned, bool,
                         bool, bool, bool, unsigned, const std::string &);
